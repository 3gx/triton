...
`fable/` records the design history and motivating examples.
...
- [`fable/semas-report3.md`](../fable/semas-report3.md) records the original
  four-step design and the later revision of the hold rule (the rule deciding
  where acquires and releases are placed; see
  [SYNC-DAG](insert-semas/sync-dag.md#crossings-and-holds)).
- [`fable/new-insert-semas-plan-2.md`](../fable/new-insert-semas-plan-2.md)
  records the implementation contract.
- [`fable/nvws-memory-planner-meta-parity.md`](../fable/nvws-memory-planner-meta-parity.md)
  records the Meta planning parity work.
- [`fable/multi-stage-phase-design-v3.md`](../fable/multi-stage-phase-design-v3.md)
  records the multi-`loop.stage` phase proof.
