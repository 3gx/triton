...
module attributes {"ttg.num-warps" = 4 : i32} {
  ...
  tt.func @stable_producer_row_and_foreign_war(%lb: i32, %ub: i32,
    ...
    // CHECK: [[READY:%.*]] = nvws.semaphore.create [[ALLOC]] false {pending_count = 1 : i32} : <[!ttg.memdesc<1x1xi32, #shared, #smem, mutable>]>
    // CHECK: [[WAR:%.*]] = nvws.semaphore.create [[ALLOC]] false {pending_count = 2 : i32} : <[!ttg.memdesc<1x1xi32, #shared, #smem, mutable>]>
...
module attributes {"ttg.num-warps" = 4 : i32} {
  ...
  tt.func @region_resets_producer_row_to_enter(%lb: i32, %ub: i32,
    ...
    // CHECK: [[R2:%.*]] = nvws.semaphore.create [[ALLOC]] false {pending_count = 1 : i32} : <[!ttg.memdesc<1x1xi32, #shared, #smem, mutable>]>
    // CHECK: [[R1:%.*]] = nvws.semaphore.create [[ALLOC]] false {pending_count = 1 : i32} : <[!ttg.memdesc<1x1xi32, #shared, #smem, mutable>]>
