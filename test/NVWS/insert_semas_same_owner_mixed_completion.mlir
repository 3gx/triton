...
module attributes {"ttg.num-ctas" = 1 : i32, "ttg.num-warps" = 4 : i32, ttg.target = "cuda:100", "ttg.threads-per-warp" = 32 : i32} {
  ...
  tt.func @same_owner_partial_overlap_mixed_completion(%desc: !tt.tensordesc<tensor<128x64xf16, #shared>>, %i: i32, %lb: i32, %ub: i32, %step: i32) {
    ...
    // CHECK: [[PARTIAL_EMPTY:%.*]] = nvws.semaphore.create [[PARTIAL_TMA_BASE]], [[PARTIAL_SYNC_BASE]] true {pending_count = 1 : i32}
    // CHECK: [[PARTIAL_FULL:%.*]] = nvws.semaphore.create [[PARTIAL_TMA_BASE]], [[PARTIAL_SYNC_BASE]] false {pending_count = 2 : i32}
    // CHECK: scf.for
    scf.for %iv = %lb to %ub step %step : i32 {
