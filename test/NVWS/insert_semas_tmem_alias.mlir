...
module attributes {"ttg.num-warps" = 4 : i32, ttg.target = "cuda:100"} {
  ...
  tt.func @tmem_reinterpret_alias(%ub: i32) {
    ...
    %r = scf.for %iv = %c0_i32 to %ub step %c1_i32 iter_args(%t = %tok) -> (!ttg.async.token) : i32 {
      ...
      // CHECK: [[BUF0:%.*]] = nvws.semaphore.buffer [[EMPTY]], {{.*}} {ttg.partition = array<i32: 0>}
      ...
      // CHECK-NEXT: [[BUF1:%.*]] = nvws.semaphore.buffer [[FULL]], [[LTOK]] {ttg.partition = array<i32: 1>}
