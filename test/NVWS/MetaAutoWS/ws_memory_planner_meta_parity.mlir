...
module attributes {"ttg.num-ctas" = 1 : i32, "ttg.num-warps" = 4 : i32, ttg.target = "cuda:100", "ttg.threads-per-warp" = 32 : i32} {
  ...
  // ODD: ttg.local_alloc {buffer.circular, buffer.copy = 3 : i32, buffer.id = [[ID:[0-9]+]] : i32, buffer.start = 0 : i32}
  // ODD-NEXT: ttg.local_alloc {buffer.circular, buffer.copy = 3 : i32, buffer.id = [[ID]] : i32, buffer.start = 1 : i32}
