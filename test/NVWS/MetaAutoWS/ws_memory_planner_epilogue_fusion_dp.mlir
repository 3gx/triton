...
// CHECK: ttng.tmem_alloc {{.*}}buffer.copy = 1 : i32, buffer.id = [[ACC1:[0-9]+]] : i32, buffer.offset = 0 : i32
// CHECK: ttng.tmem_alloc {{.*}}buffer.copy = 1 : i32, buffer.id = [[ACC0:[0-9]+]] : i32, buffer.offset = 0 : i32
