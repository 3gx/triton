// RUN: triton-opt %s --nvws-memory-planner=num-buffers=3 --mlir-print-debuginfo --mlir-use-nameloc-as-prefix 2>&1 | FileCheck %s
...
// CHECK: %acc_0 = ttng.tmem_alloc {buffer.copy = 1 : i32, buffer.id = [[ACC0:[0-9]+]] : i32, buffer.offset = 0 : i32}
// CHECK: %alpha_1, %alpha_1_0 = ttng.tmem_alloc {buffer.copy = 1 : i32, buffer.id = [[ACC1]] : i32, buffer.offset = 64 : i32}
// CHECK: %alpha_0, %alpha_0_1 = ttng.tmem_alloc {buffer.copy = 1 : i32, buffer.id = [[ACC0]] : i32, buffer.offset = 64 : i32}
// CHECK: %qk_1, %qk_1_2 = ttng.tmem_alloc {buffer.copy = 1 : i32, buffer.id = [[ACC1]] : i32, buffer.offset = 0 : i32}
// CHECK: %qk_0, %qk_0_3 = ttng.tmem_alloc {buffer.copy = 1 : i32, buffer.id = [[ACC0]] : i32, buffer.offset = 0 : i32}
// CHECK: %m_ij_1, %m_ij_1_4 = ttng.tmem_alloc {{.*}}buffer.offset = 65 : i32
// CHECK: %l_i0_0, %l_i0_0_5 = ttng.tmem_alloc {{.*}}buffer.offset = 66 : i32
// CHECK: %acc_1_8, %acc_1_9 = ttng.tmem_alloc {{.*}}buffer.copy = 1 : i32, buffer.id = {{[0-9]+}} : i32
// CHECK: %acc_0_10, %acc_0_11 = ttng.tmem_alloc {{.*}}buffer.copy = 1 : i32, buffer.id = {{[0-9]+}} : i32
