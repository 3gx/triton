// RUN: triton-opt %s -split-input-file --nvws-hoist-tmem-store | FileCheck %s
...
module attributes {"ttg.num-ctas" = 1 : i32, "ttg.num-warps" = 4 : i32, ttg.target = "cuda:100", "ttg.threads-per-warp" = 32 : i32} {
  ...
  // NVWSHoistTmemStore only folds/hoists inside tt.warp_specialize loops.
  // This standalone loop-invariant store remains in the outer loop.
  // CHECK: scf.for
