...
module attributes {"ttg.num-warps" = 4 : i32} {
  ...
  ^work:
    ...
    // CHECK: [[EMPTY:%.*]] = nvws.semaphore.create [[BACKING]] true {pending_count = 1 : i32} : <[!ttg.memdesc<1x1xi32, #shared, #smem, mutable>]>
    // CHECK: [[FULL:%.*]] = nvws.semaphore.create [[BACKING]] false {pending_count = 1 : i32} : <[!ttg.memdesc<1x1xi32, #shared, #smem, mutable>]>
