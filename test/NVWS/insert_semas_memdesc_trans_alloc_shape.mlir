...
module attributes {"ttg.num-warps" = 4 : i32, ttg.target = "cuda:100"} {
  ...
  tt.func @memdesc_trans_preserves_staged_alloc_shape(
    ...
    // CHECK: [[V3:%.*]] = nvws.semaphore.create [[V1]], [[V2]] true {pending_count = 1 : i32} : <[!ttg.memdesc<3x128x64xf16, #shared, #smem, mutable>, !ttg.memdesc<3x256x64xf16, #shared, #smem, mutable>]>
    // CHECK: [[V4:%.*]] = nvws.semaphore.create [[V1]], [[V2]] false {pending_count = 1 : i32} : <[!ttg.memdesc<3x128x64xf16, #shared, #smem, mutable>, !ttg.memdesc<3x256x64xf16, #shared, #smem, mutable>]>
