// RUN: triton-opt %s -split-input-file -allow-unregistered-dialect '--nvws-insert-semas=placement-mode=pou' -cse | FileCheck %s
...
module attributes {"ttg.num-warps" = 4 : i32} {
  ...
  tt.func @root_continuation(%lb: i32, %ub: i32, %step: i32, %cond: i1) {
    ...
    // CHECK-NEXT: [[ROOT_EMPTY:%[0-9]+]] = nvws.semaphore.create [[ROOT_WHOLE]], [[ROOT_LEFT]], [[ROOT_RIGHT]] true {pending_count = 1 : i32}
    // CHECK-NEXT: [[ROOT_FULL:%[0-9]+]] = nvws.semaphore.create [[ROOT_WHOLE]], [[ROOT_LEFT]], [[ROOT_RIGHT]] false {pending_count = 1 : i32}
    // CHECK-NEXT: [[ROOT_LEFT_READY:%[0-9]+]] = nvws.semaphore.create [[ROOT_WHOLE]], [[ROOT_LEFT]], [[ROOT_RIGHT]] false {pending_count = 1 : i32}
    // CHECK-NEXT: [[ROOT_RIGHT_READY:%[0-9]+]] = nvws.semaphore.create [[ROOT_WHOLE]], [[ROOT_LEFT]], [[ROOT_RIGHT]] false {pending_count = 1 : i32}
...
module attributes {"ttg.num-warps" = 4 : i32} {
  ...
  tt.func @partition_2_then_partition_3(%lb: i32, %ub: i32, %step: i32,
    ...
    // CHECK-NEXT: [[P23_EMPTY:%[0-9]+]] = nvws.semaphore.create [[P23_WHOLE]], [[P23_LEFT]], [[P23_RIGHT]] true {pending_count = 1 : i32}
    // CHECK-NEXT: [[P23_FULL:%[0-9]+]] = nvws.semaphore.create [[P23_WHOLE]], [[P23_LEFT]], [[P23_RIGHT]] false {pending_count = 1 : i32}
    // CHECK-NEXT: [[P23_ROOT_READY:%[0-9]+]] = nvws.semaphore.create [[P23_WHOLE]], [[P23_LEFT]], [[P23_RIGHT]] false {pending_count = 1 : i32}
    // CHECK-NEXT: [[P23_THEN_READY:%[0-9]+]] = nvws.semaphore.create [[P23_WHOLE]], [[P23_LEFT]], [[P23_RIGHT]] false {pending_count = 1 : i32}
    // CHECK-NEXT: [[P23_ELSE_READY:%[0-9]+]] = nvws.semaphore.create [[P23_WHOLE]], [[P23_LEFT]], [[P23_RIGHT]] false {pending_count = 1 : i32}
    // CHECK-NEXT: [[P23_RIGHT_READY:%[0-9]+]] = nvws.semaphore.create [[P23_WHOLE]], [[P23_LEFT]], [[P23_RIGHT]] false {pending_count = 1 : i32}
...
module attributes {"ttg.num-warps" = 4 : i32} {
  ...
  tt.func @partition_1_then_partition_0(%lb: i32, %ub: i32, %step: i32,
    ...
    // CHECK-NEXT: [[P10_EMPTY:%[0-9]+]] = nvws.semaphore.create [[P10_WHOLE]], [[P10_LEFT]], [[P10_RIGHT]] true {pending_count = 1 : i32}
    // CHECK-NEXT: [[P10_FULL:%[0-9]+]] = nvws.semaphore.create [[P10_WHOLE]], [[P10_LEFT]], [[P10_RIGHT]] false {pending_count = 1 : i32}
    // CHECK-NEXT: [[P10_ROOT_READY:%[0-9]+]] = nvws.semaphore.create [[P10_WHOLE]], [[P10_LEFT]], [[P10_RIGHT]] false {pending_count = 1 : i32}
    // CHECK-NEXT: [[P10_THEN_READY:%[0-9]+]] = nvws.semaphore.create [[P10_WHOLE]], [[P10_LEFT]], [[P10_RIGHT]] false {pending_count = 1 : i32}
    // CHECK-NEXT: [[P10_ELSE_READY:%[0-9]+]] = nvws.semaphore.create [[P10_WHOLE]], [[P10_LEFT]], [[P10_RIGHT]] false {pending_count = 1 : i32}
