...
module attributes {"ttg.num-warps" = 4 : i32} {
  ...
  tt.func @local_memdesc_subslice_alias(%lb: i32, %ub: i32, %step: i32) {
    ...
    // CHECK-NEXT: [[EMPTY:%[0-9]+]] = nvws.semaphore.create [[BASE]] true {pending_count = 1 : i32} : <[!ttg.memdesc<1x2xi32, #shared, #smem, mutable>]>
    // CHECK-NEXT: [[FULL:%[0-9]+]] = nvws.semaphore.create [[BASE]] false {pending_count = 1 : i32} : <[!ttg.memdesc<1x2xi32, #shared, #smem, mutable>]>
