...
// is unrealizable. Phase 3.6 therefore does NOT mark it, and the floor is
// honored by the ship-anyway backstop (the real HW limit, not the soft budget).
//
...
//     so Phase 3.6 leaves them standalone rather than marking unrealizable
//     reuse.
...
// Starting directly with buffer.copy confirms no allocation.* reuse attribute
// was stamped on the encoding-incompatible staging allocation.
