...
static LogicalResult buildOwnerDag(GroupDag &g) {
...
// ---------------------------------------------------------------------------
static void printPieceRecord(llvm::raw_ostream &os, const Node *n,
                             Operation *anchor) {
...
static void dumpGroupOwnerDag(GroupDag &g, triton::FuncOp funcOp) {
  auto &os = llvm::errs();
  os << "OWNER-DAG\n";
