...
from triton.experimental.gluon.language._layouts import SharedLinearLayout, SliceLayout
...
class tensor_memory_descriptor(base_value):
    ...
    def load(self, layout, red_op=None, abs=False, NaN=False, _semantic: GluonSemantic = None):
        ...
        if red_op is None:
            ...
            result, reduced = builder.create_tmem_load(
                ret_ty.to_ir(builder), self.handle,
                red_ty.to_ir(builder), red_op,
                abs_flag, nan_flag)
