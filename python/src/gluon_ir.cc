...
void init_gluon_ir(py::module &&m) {
  ...
  py::enum_<ttng::TMEMLoadReduceModifier>(m, "TMEM_LOAD_REDUCE_MODIFIER", py::module_local())
      .value("MIN", ttng::TMEMLoadReduceModifier::MIN)
      .value("MAX", ttng::TMEMLoadReduceModifier::MAX).export_values();
  ...
  py::class_<GluonOpBuilder, TritonOpBuilder>(
      ...
      .def("create_tmem_load",
           [](GluonOpBuilder &self, Type resultTy, Value memDesc,
              std::optional<Type> redTy, std::optional<ttng::TMEMLoadReduceModifier> redOp,
              bool useAbs, bool useNaN) -> py::object {
